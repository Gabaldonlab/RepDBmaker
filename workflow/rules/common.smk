...
rule get_eukprot_genomes:
    ...
    output:
        "results/proteomes/ep/{genome}.faa.gz",
    localrule: True
    conda:
        "../envs/utils.yaml"
    shell:
...
rule get_p10k_genomes:
    output:
        "results/proteomes/p10k/{genome}.faa.gz",
    localrule: True
    conda:
        "../envs/utils.yaml"
    shell:
...
rule extract_virus:
    ...
    output:
        "results/proteomes/virus/{virus}.faa.gz",
    localrule: True
    conda:
        "../envs/utils.yaml"
    shell:
...
rule repdb_online_genomes:
    ...
    input:
        ...
        p10k_repdb,
    output:
        "results/dbs/repdb/online_gnms.txt",
    localrule: True
    conda:
        "../envs/utils.yaml"
    shell:
...
rule repdb_genome_table:
    ...
    input:
        ...
        viruses_repdb,
    output:
        "results/dbs/repdb/genome_table.tsv",
    localrule: True
    conda:
        "../envs/python.yaml"
    script:
        "../scripts/make_genome_table.py"
